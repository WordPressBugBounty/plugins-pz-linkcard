...
<div class="pz-page" id="pz-check">
	...
	<h2><?php echo	__('Link Check Settings', PZLKC_TEXT_DOMAIN ).$help_open.'link-check'.$help_close; ?></h2>
	<table class="form-table">
		<tr>
			<th scope="row"><?php _e('Set No-Follow', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php	echo __('In the case of an external site, it puts the "nofollow".', PZLKC_TEXT_DOMAIN ).__('(Deprecation)', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Set No-Opener', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php	echo __('In the case of an external site, it puts the "noopener".', PZLKC_TEXT_DOMAIN ).__('(Recommend)', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Set Referer', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('Notify the article URL to the link destination.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Relative URL', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('For relative-specified URLs, complement the site URL.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Do Not Link at Error', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('When access status is "403", "404", "410", unlink.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Disable SSL Verification', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('Try setting if the contents of the SSL site can not be acquired.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Follow Location', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('Track when the link destination is redirected.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Use User-Agent', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('Notify using Pz-LinkCard to the link destination.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
				<p>&emsp;&ensp;<input name="properties[user-agent]" type="text" size="80" value="<?php echo	esc_attr($this->options['user-agent'] ); ?>" /></p>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Click Count', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
				...
				<?php _e('The card management screen displays the total number of clicks to date.', PZLKC_TEXT_DOMAIN ); ?>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Broken Link Checker', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('Alive confirmation of the link destination.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e('Broken Link Count', PZLKC_TEXT_DOMAIN ); ?></th>
			<td>
				<label>
					...
					<?php _e('The number of broken links is displayed next to the submenu.', PZLKC_TEXT_DOMAIN ); ?>
				</label>
			</td>
		</tr>
	</table>
